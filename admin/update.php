...
if ($getVersions != '') {
        ...
        if ($aV > $version) {
            ...
            if (!is_file('../tmp/multisite-'.$aV.'.zip')) {
                ...
                if (!fwrite($dlHandler, $newUpdate)) {
                    echo '<p><div class="alert alert-danger">Could not save new update. Operation aborted.</div></p>';
                    exit();
                }
                fclose($dlHandler);
            ...
            if ($_GET['doUpdate'] == true) {
                ...
                echo '</div><div class="alert alert-success"><p>Update ready. <a href="?doUpdate=true">&raquo; Install Now?</a></p></div>';
            }
            break;
        }
    }
 ...
 ';
        ...
        echo '<div class="alert alert-danger"><p>&raquo; No update is available.</p></div>';
    }
} else {
    echo '<div class="alert alert-danger"><p>Could not find latest realeases.</p></div>';
}
?>
<?php
